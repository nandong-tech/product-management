...
| 2026-09-18 | Updated on Confluence       | Nan Dong | AC-07 Order Details; take wiki AC-02 |
...
| Figma                | N / A                                                                                                                                                                                                                                                                                                         |
| Confluence           | [PRD: LF-S-056 - Transaction History](https://lotusflare.atlassian.net/wiki/spaces/AIDR/pages/7817691241/PRD+LF-S-056+-+Transaction+History) |
| Jira                 | —                                                                                                                                                                                                                                                                                                             |
| API Spec             | N / A                                                                                                                                                                                                                                                                                                         |
...
| AC-02 | The Transaction History screen is shown and a transaction is shown | The user views that transaction     | - The order id is shown<br>- The transaction amount is shown<br>- The transaction date is shown and uses the shared date format<br>- The transaction time is shown |
...
| AC-07 | The Transaction History screen is shown and a transaction is shown | The user selects that transaction   | The user is taken to Order Details (LF-S-057)                                                                                                                                          |
