...
| ID    | Given | When | Then |
| ----- | ----- | ---- | ---- |
| AC-01 | The Transaction History screen is shown | The user views the screen | - Page title "Transaction history" is shown<br>- **All**, **SIM offers**, and **Data offers** are shown and can be selected<br>- **All** is selected by default<br>- The transaction list is shown |
| AC-02 | The Transaction History screen is shown and a transaction is shown | The user views that transaction | - The transaction description is shown<br>- The transaction date is shown and uses the shared date format<br>- The transaction time is shown |
